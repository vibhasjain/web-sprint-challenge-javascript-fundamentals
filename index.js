...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//nestedFunction is a closure as it sits within myFunction. It automatically gets access to all variables declared within myFunction
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const lowerCaseNames = array.map(x => x.animal_name.toLowerCase());
  ...
  */
  ...
  function USApop(array){
    const totalPopulation = array.reduce((x,y) => x+y.population,0); 
